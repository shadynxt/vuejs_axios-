    ...
    <div>
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center mb-4 pb-2">
                        <h4 class="title mb-4">Our contacts</h4>
                        <p class="text-muted para-desc mx-auto mb-0">There is now an abundance of readable dummy texts.
                            These are usually used when a text is required purely to fill a space.</p>
                    </div>
                </div><!--end col-->
        ...
        <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-4">
            ...
            <div class="col" v-for="team_member in team_members">
		<div class="card radius-15">
			<div class="card-body text-center">
				<div class="p-4 border radius-15">
					<img :src="team_member.avatar" width="110" height="110" class="rounded-circle shadow" alt="">
					<h5 class="mb-0 mt-5">{{ team_member.name }}</h5>
					<p class="mb-3">{{ team_member.title }}</p>
...
export default {
    ...
    methods: {
        ...
        // I a new ecmascript feature async / await instead of promises
        async getContactsList() {
            const res = await axios.get('/api/features');
                if (res.data.success === true){
                    this.team_members = res.data.teamMembers;
